...
//         alt="About Us"
//         className="w-full h-[400px] lg:h-[600px] rounded-[20px] shadow-lg  mt-10 lg:mt-0 border-b-12  border-[#889F2D]"/>
//       </div>
...
export default function AboutUsSecond() {
  return (
    <section className="common-section flex flex-col md:flex-row items-center gap-12 px-4 sm:px-6 md:px-16 bg-[#fcfcfc]">
