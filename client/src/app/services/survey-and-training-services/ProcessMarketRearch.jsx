...
export default function ProcessMarketRearch() {
  return (
    <section className='flex flex-col justify-center pt-[50px] pb-[50px] '>
        <div className="text-center mb-10">
        <h3 className="title text-[#889F2D]">How We Work</h3>
        <h2 className="center-section-heading"> A structured process for reliable outcomes </h2>
        ...
        Understanding objectives, target audience, and desired outcomes.</h2>
        </div>
        </motion.div>
        ...
        <h2 className='process-bullet-section-desc' >
        <b className='process-bullet-section-heading text-[#7b0000]'>Research Design:-</b><br />
        Selecting appropriate methodologies and sampling frameworks.</h2>
        </div>
        </motion.div>
        ...
        Conducting field, online, or telephonic surveys using validated tools.</h2>
        </div>
        </motion.div>
        ...
        <h2 className='process-bullet-section-desc'>
        <b className='process-bullet-section-heading text-[#7b0000]'>Data Analysis:-</b> <br />
        Using statistical models to derive actionable insights.</h2>
        </div>
        </motion.div>
        ...
        <h2 className='process-bullet-section-desc'>
        <b className='process-bullet-section-heading text-[#7b0000]'>Reporting:-</b><br />
        Presenting clear, visual, and business-oriented reports.</h2>
        </div>
        </motion.div>
        ...
        <h2 className='process-bullet-section-desc'>
        <b className='process-bullet-section-heading text-[#7b0000]'>Training & Implementation:-</b><br />
        Translating insights into action through skill-building programs.</h2>
        </div>
        </motion.div>
