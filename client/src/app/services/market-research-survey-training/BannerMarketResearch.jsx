...
export default function BannerMarketResearch() {
  return (
   <section className=" relative h-[500px] md:h-[600px] sm:h-[400px] lg:h-[600px] flex items-start bg-cover bg-center justify-center lg:pt-[120px] pt-[60px]"
    ...
    <div className="section relative z-10 lg:max-w-6xl px-6 sm:px-4 lg:px-8 text-center">
        <h2 className="
            heading text-[#7B0000] lg:pb-6 sm:pb-4">INSIGHTS. INTELLIGENCE. IMPACT. </h2>
               <h3 className='text-center title mt-5'>Empowering businesses with data-driven decisions through expert Market Research, Field Surveys, and Customized Training Programs.</h3>
