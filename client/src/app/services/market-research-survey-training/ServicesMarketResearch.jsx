...
export default function ServicesMarketResearch() {

      const [marketResearch, setmarketResearch] = useState([]);
        
          useEffect(() => {
            fetch("/data/services/market-research-survey-training/Service.json")
              .then((res) => res.json())
  ...
  return (
      ...
      <div className="text-center mb-10">
        ...
        <h2 className="center-section-heading">COMPREHENSIVE MEP ENGINEERING SOLUTIONS</h2>
