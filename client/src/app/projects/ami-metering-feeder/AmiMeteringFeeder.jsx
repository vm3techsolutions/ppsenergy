...
export default function AmiMeteringFeeder() {
  return (
        <section className='common-section'>
            ...
            <h2 className="center-section-heading">AMI, SMART METERING & FEEDER AUTOMATION
             ...
             <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-2 gap-10">
              ...
              <p className="content text-[#3D3D3D]  text-left  lg:mr-[100px] ">
                We design, implement, and audit advanced metering infrastructure (AMI), smart metering systems, and feeder-level automation to help utilities transition to digital, high-efficiency operations.
              </p>
             ...
             {/* Experties */}
                 <h3 className='team-members-designation mt-4'>Our Expertise Includes</h3>
                        <ul className="space-y-3 bulletPoints text-[#3D3D3D]  mt-2">
                          {[
                            "AMI system design",
                            "Smart meter installation & QC",
                            "MDMS data validation",
                            "Feeder automation & SCADA integration",
                            "Streetlight metering solutions",
                            "Solar/wind energy metering"
                          ].map((item, index) => (
          ...
          {/* Image Section */}
            ...
            <Image
              width={678}
              height={574}
              src="/assets/projects/AMIBannerInfo.jpg"
              alt="About Us"
